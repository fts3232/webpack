...
<div class="cid_intro">
	...
	<a href="{{ route('liveAccount') }}" target="_blank" class="btn btn_r wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="1s">Start Trading Now</a>
</div>
	...
	<div class="container">
		...
		<div class="step_list clearfix">
			...
			<div class="item wow fadeInDown" data-wow-delay="1.1s">
				<i class="img"></i>
				<span class="yellow">3. Deposit</span>
		...
		<a href="{{ route('liveAccount') }}" target="_blank" class="btn red wow fadeInUp" data-wow-delay="1.2s">Get Started</a>
	</div>
</div>
<div class="home_mt4">
	<div class="container">
		...
		<div class="clearfix">
			<div class="plat_l">
				...
				<a href="{{ route('MT4') }}" target="_blank" class="btn btn_r wow slideInLeft">Start Trading Now</a>
				<h3 class="h_h3 wow slideInLeft"><i class="icon"></i>MT4 Download</h3>
				<div class="download clearfix">
					<a href="{{ route('downloadMT4ForPC') }}" class="wow fadeInUpBig" data-wow-delay="0.25s"><i class="wins"></i>Windows</a>
					<a href="{{ route('downloadMT4ForPC') }}" class="wow fadeInUpBig" data-wow-delay="0.5s"><i class="os"></i>Mac OS</a>
					<a href="{{ route('downloadMT4ForAndroid') }}" class="wow fadeInUpBig" data-wow-delay="0.75s"><i class="andr"></i>Android</a>
	...
	<div class="container">
		...
		<div class="f_list clearfix">
			<div class="item wow fadeInDown" data-wow-delay="0.2s">
				...
				<a href="{{ route('about') }}" target="_blank" class="btn readmore">Read More</a>
			</div>
