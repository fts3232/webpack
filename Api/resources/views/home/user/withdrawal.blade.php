...
<div class="accounts_body aboutus clearfix">
	<div class="container">
		<div class="location">
			<i class="icon"></i>Location： <a href="{{ url('/') }}" class="link">Home</a> > Customer Center > Account withdrawal
		</div>
		<div class="navbox">
			<!--左侧导航-->
					...
					<div class="comfirm_info">
						<div class="infomation">
							<ul>
								...
								<li>
									<div class="td">Withdrawal Amount : <input type="number" name="withd_amot" class="input_p" placeholder="Fill out the withdrawal amount"></div>
								</li>
								<li>
									<div class="tr ">
										<input type="checkbox" id="checkbox" class="checkbox" name="agree" />
										<label for="checkbox" class="ckbox"><i class="icon"></i></label>
										A single withdrawal of less than $50 will be deducted from the withdrawal amount of $3 as a withdrawal fee
									</div>
								</li>
								<li>
