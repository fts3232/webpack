...
<div class="accounts_body aboutus clearfix">
	<div class="container">
		<div class="location">
			<i class="icon"></i>Location： <a href="{{ url('/') }}" class="link">Home</a> > Customer Center > Bank Injection
		</div>
		<div class="navbox">
			<!--左侧导航-->
			...
			<div class="rgtcon">
				...
				<form class="personal_info" action="{{ url('/user/injection') }}" method="post" enctype="multipart/form-data">
