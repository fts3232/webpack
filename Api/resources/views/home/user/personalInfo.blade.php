...
<div class="accounts_body aboutus clearfix">
	<div class="container">
		<div class="location">
			<i class="icon"></i>Location： <a href="{{ url('/') }}" class="link">Home</a> > Customer Center > Personal Information
		</div>
		<div class="navbox">
			<!--左侧导航-->
				...
				<div class="personal_info">
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<a href="{{ url('/member/onlineDeposit') }}" class="btn bg">Deposit</a>
									<a href="#" class="btn">Withdrawals</a>
								</td>
								<td><a href="{{ url('/account/trading') }}" class="btn bg" target="_blank">New Account</a></td>
							</tr>
						</tbody>
					</table>
					<!-- 银行信息 -->
					...
					<iframe name="uploadFrame" style="display:none"></iframe>
						<div class="stepbox clearfix">
						    <form target="uploadFrame" action="{{ url('/user/uploadPic') }}" method="post" class="upload_form" enctype="multipart/form-data" >
    							<div class="item">
