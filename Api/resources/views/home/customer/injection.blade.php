...
<div class="accounts_body aboutus clearfix">
	<div class="container">
		<div class="location">
			<i class="icon"></i>Location： <a href="{{ route('home') }}" class="link">Home</a> > Customer Center > Bank Injection
		</div>
		<div class="navbox">
			<!--左侧导航-->
			...
			<div class="rgtcon">
				...
				<form class="personal_info" action="{{ route('injection') }}" method="post" enctype="multipart/form-data">
					<div class="comfirm_info">
						<div class="infomation inj">
							<ul>
								<li>
								...
								<li>
									<div class="td">Account currency : <small>USD</small></div>
								</li>
								<li>
									<div class="td">
				...
				<div class="congratulate">
					...
					<a href="{{ route('home') }}" class="btn sbtn bg">Home</a>
