...
class Popover extends Component {
    ...
    render() {
        ...
        return(
            <div className={this.className('popover')} onMouseOver={this.onMouseOver.bind(this)} onMouseOut={this.onMouseOut.bind(this)}>
            	<div className="popover-rel" ref='rel'>
            		{children}
            	</div>
            	<div className={this.classNames('popover-poper',placement)} ref='poper'>
            		<span>{content}</span>
...
Popover.propTypes={//属性校验器，表示改属性必须是bool，否则报错
